...
#ifndef SEQUENCE_STAR_ID_H_
#define SEQUENCE_STAR_ID_H_
...
class sequence_star_id : public sequence_base<REQ,RSP> {

public:
    sequence_star_id( const std::string& name )
    ...
    UVM_OBJECT_PARAM_UTILS(sequence_star_id<REQ,RSP>)
};

#endif /* SEQUENCE_STAR_ID_H_ */
